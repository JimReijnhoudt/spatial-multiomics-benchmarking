...
def run_vertical_spatialmeta(iteration_dir, n_latent, hidden_stacks, lr, max_epoch):
...
parser.add_argument("-m", "--max_epoch", type=int, help="Input for learning rate")
...
# Run SpatialMETA
peak_memory, results = memory_usage((run_vertical_spatialmeta, (), {"iteration_dir": iteration_dir, "n_latent": n_latent, "hidden_stacks": hidden_stacks, "lr": lr, "max_epoch": max_epoch}), retval=True, max_usage=True)
