def run_vertical_spatialmeta(iteration_dir):
...
for iteration in range(2):
    ...
    iteration_dir = f"benchmarks/results/automated/plots/iteration_{iteration}"
    os.makedirs(iteration_dir, exist_ok=True)
    
    start = time.perf_counter()

    results_run, results_metrics_run = run_vertical_spatialmeta(iteration_dir)
