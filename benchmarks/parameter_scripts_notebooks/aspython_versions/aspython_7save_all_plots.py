def run_vertical_spatialmeta(iteration):
    ...
    plt.tight_layout()
    plt.savefig(f"benchmarks/results/automated/plots/loss_visualization_{iteration}.png", bbox_inches="tight")
    #plt.show()
    ...
    plt.savefig(f"benchmarks/results/automated/plots/umap_{iteration}.png", bbox_inches="tight")
    ...
    plt.savefig(f"benchmarks/results/automated/plots/spatial_{iteration}.png", bbox_inches="tight")
    ...
    sc.pl.spatial(joint_adata,
                ...
                layer="normalized",
                show=False)
    plt.savefig(f"benchmarks/results/automated/plots/normalized1_{iteration}.png", bbox_inches="tight")
    ...
    sc.pl.spatial(joint_adata,
                ...
                show=False)
    plt.savefig(f"benchmarks/results/automated/plots/reconstructed_{iteration}.png", bbox_inches="tight")
    ...
    plt.savefig(f"benchmarks/results/automated/plots/normalized2_{iteration}.png", bbox_inches="tight")
    ...
    plt.savefig(f"benchmarks/results/automated/plots/violin_plot_{iteration}.png", bbox_inches="tight")
    #plt.show()
