...
for i in range(2):
    ...
    results1, results_metrics1 = run_vertical_spatialmeta()

    runtime = time.perf_counter() - start

    results_list.append(results1)
    results_metrics_list.append(results_metrics1)

df = pd.DataFrame(results_metrics_list)

print(results_metrics_list)
print("succes")